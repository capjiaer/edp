...
class TranslateCmd:
	...
	def replace_check(tcl_interp_obj, var_list):
		...
		if var_list:
			for ele in var_list:
				ele = ele[1:]
				if int(tcl_interp_obj.eval("info exist {}".format(ele))) != 1 or str(tcl_interp_obj.getvar(ele)) == "0" or str(tcl_interp_obj.getvar(ele)) == "":
					return_flag = 0
		else:
			return return_flag
		return return_flag
...
if __name__ == "__main__":
	...
	str1 = "{b a}"
	print(TranslateCmd.reset_value(str1))
